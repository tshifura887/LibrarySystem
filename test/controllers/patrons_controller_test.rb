...
class PatronsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patron" do
    assert_difference('Patron.count') do
      post patrons_url, params: { patron: { first_name: @patron.first_name, last_name: @patron.last_name } }
    end
  ...
  test "should update patron" do
    patch patron_url(@patron), params: { patron: { first_name: @patron.first_name, last_name: @patron.last_name } }
